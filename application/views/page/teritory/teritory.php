<div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
            <div class="card-body">
                <h4 class="card-title">Teritory</h4>
                <p class="card-description">
                    <a href="<?php echo site_url('teritory/add'); ?>" class="btn btn-outline-primary btn-icon-text">
                ...
                <div class="table-responsive">
                    <table id="tableuser" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            <?php $no=1; foreach ($getteritory as $row) : ?>
                                <tr>
                                    <td style="vertical-align:middle;" align="center"><?php echo $no; ?></td>
                                    <td style="vertical-align:middle;"><?php echo $row->teritory; ?></td>
                                    <td style="vertical-align:middle;" align="center"><?php echo $row->area; ?></td>
                                    <td style="vertical-align:middle;" align="center">
                                        <?php 
                                            $cek=$this->db->query("select * from ro where id_sto='$row->ro'")->num_rows();
                                            if ($cek>0)
                                                echo $this->db->query("select * from ro where id_sto='$row->ro'")->row()->nama_sto;
                                            else
                                                echo "-";
                                        ?>
                                    </td>
                                    ...
                                    <td align="center" style="vertical-align:middle;">
                                        <div class="btn-group">
                                            ...
                                            <a href="<?php echo site_url("teritory/edit/".$row->id_teritory); ?>" class="btn btn-success"><center><i class="mdi mdi-pencil-box-outline" style="font-size:16px;" ></i></center></a>
                                            <a href="<?php echo site_url("teritory/hapus/".$row->id_teritory); ?>" class="btn btn-danger item-hapus"><center><i class="mdi mdi-delete" style="font-size:16px;"></i></center></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php $no++; endforeach; ?>
