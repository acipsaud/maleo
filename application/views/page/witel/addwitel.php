            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    ...
                    <form class="pt-3" role="form" method="POST" action="<?php echo site_url('witel/save') ?>">
                        <div class="form-group">
                            Witel 
                            <input type="text" class="form-control " value=" <?= set_value('witel'); ?>" id="witel" name="witel" placeholder="witel">
