<div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
            <div class="card-body">
                <h4 class="card-title">Witel</h4>
                <p class="card-description">
                    <a href="<?php echo site_url('witel/add'); ?>" class="btn btn-outline-primary btn-icon-text">
                ...
                <div class="table-responsive">
                    <table id="tableuser" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            <?php $no=1; foreach ($getwitel as $row) : ?>
                                <tr>
                                    <td style="vertical-align:middle;" align="center"><?php echo $no; ?></td>
                                    <td style="vertical-align:middle;"><?php echo $row->witel; ?></td>
                                    ...
                                    <td align="center" style="vertical-align:middle;">
                                        <div class="btn-group">
                                            ...
                                            <a href="<?php echo site_url("witel/edit/".$row->id_witel); ?>" class="btn btn-success"><center><i class="mdi mdi-pencil-box-outline" style="font-size:16px;" ></i></center></a>
                                            <a href="<?php echo site_url("witel/hapus/".$row->id_witel); ?>" class="btn btn-danger item-hapus"><center><i class="mdi mdi-delete" style="font-size:16px;"></i></center></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php $no++; endforeach; ?>
