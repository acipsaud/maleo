                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;" align="center">
                                        <?php
                                            ...
                                            $getrankdatel=$this->db->query("select $bulanac as ac from kinerja where id_indikator='$row->id_indikator' and tanding='Datel'")->result();
                                            $i=0;
                                    ...
                                    <td align="center" style="vertical-align:middle;">
                                        <div class="btn-group">
                                            <a href="<?php echo site_url("kinerja/cek_detail/$row->id_kinerja/$getter/datel"); ?>" class="btn btn-default"><center><i class="mdi mdi-format-list-bulleted" style="font-size:16px;" ></i></center></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php $no++; endforeach; ?>
