<div class="content-wrapper">
    <div class="row">
        <!-- <div class="col-lg-5 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <p class="card-title mb-0">Detail Kinerja STO</p><br>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <p class="card-title">Flaging <font color="red"> STO</font> based on Average Achievement
                        </p>
                    </div>
                    <?php
                        $dataach=array();
                        $getareadatel=$this->db->query("SELECT * FROM `teritory` where area='STO'")->result();
                        $no=0;
                        foreach ($getareadatel as $rowarea) :
                            ...
                            $bulanac='ac'.date('m');
                            $getach=$this->db->query("SELECT $bulanac as bulanach,indikator,id_uic_witel,teritory FROM `kinerja` where teritory='$rowarea->id_teritory'")->result();
                            $jumlahach=0;
                            $getjml=0;
