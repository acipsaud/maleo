<div class="content-wrapper">
    <div class="row">
        <!-- <div class="col-lg-5 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <p class="card-title mb-0">Detail Kinerja Hero</p><br>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <p class="card-title">Flaging <font color="red"> Hero </font> based on Average Achievement
                        </p>
                    </div>
                    <?php
                        $dataach=array();
                        $getareadatel=$this->db->query("SELECT * FROM `teritory` where area='HERO'")->result();
                        $no=0;
