        ...
        <div class="col-lg-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="">
                        <tr>
                            <form class="pt-3" role="form" method="POST" action="<?php echo site_url('kinerja/hero_detail') ?>">
                            <td style="width:10%;">
                                Pilih Hero :
                                <select class="form-control" id="teritory" name="teritory" placeholder="teritory" style="color:#000;width:200px;"> 
                                    <?php 
                                        $getdatel=$this->db->query("select * from teritory where area='Hero'")->result();
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <?php $getarea=$this->db->query("SELECT DISTINCT(teritory) FROM `kinerja` where tanding='HERO'")->result(); ?>
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;" align="center">
                                        <?php
                                            ...
                                            $getrankdatel=$this->db->query("select $bulanac as ac from kinerja where id_indikator='$row->id_indikator' and tanding='Hero'")->result();
                                            $i=0;
                                    ...
                                    <td align="center" style="vertical-align:middle;">
                                        <div class="btn-group">
                                            <a href="<?php echo site_url("kinerja/cek_detail/$row->id_kinerja/$getter/hero"); ?>" class="btn btn-default"><center><i class="mdi mdi-format-list-bulleted" style="font-size:16px;" ></i></center></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php $no++; endforeach; ?>
