                ...
                <div class="card-body">
                  ...
                  <p class="card-description">
                    ...
                    <form class="pt-3" role="form" method="POST" action="<?php echo site_url('manageuser/update') ?>">
                        ...
                        <?php } else { ?>
                            <input type="hidden" class="form-control " value="<?php echo $getuser->password; ?>" id="mainpassword" name="mainpassword" placeholder="mainpassword">
                            <input type="hidden" class="form-control " value="123456" id="password" name="password" placeholder="password">
                        <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="teritory" name="teritory" placeholder="teritory" style="color:#000;"> 
                                <option value="<?php echo $getuser->teritory; ?>"><?php echo $this->db->query("select * from teritory where id_teritory='$getuser->teritory'")->row()->teritory ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="loker" name="loker" placeholder="loker" style="color:#000;">
                                <option value="<?php echo $getuser->loker; ?>"><?php echo $this->db->query("select * from loker where id_loker='$getuser->loker'")->row()->nama_loker; ?></option>
